 ...
 */
export function Callout({type = "success", children, className}: CalloutProps) {
    // Variables
    let style = ""
    ...
    return <div className={cn("text-lg border-1 rounded-lg p-3 text-white/70", style, className)}>{children}</div>;
}
